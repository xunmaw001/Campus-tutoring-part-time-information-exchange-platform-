...
public class JiajiaoOrderView extends JiajiaoOrderEntity implements Serializable {
	...
	public JiajiaoOrderView() {

	}

	public JiajiaoOrderView(JiajiaoOrderEntity jiajiaoOrderEntity) {
		try {
			BeanUtils.copyProperties(this, jiajiaoOrderEntity);
