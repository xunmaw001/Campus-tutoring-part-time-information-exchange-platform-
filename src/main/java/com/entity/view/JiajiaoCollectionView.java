 ...
 * @date 2021-05-06
 */
@TableName("jiajiao_collection")
public class JiajiaoCollectionView extends JiajiaoCollectionEntity implements Serializable {
	...
	public JiajiaoCollectionView() {

	}

	public JiajiaoCollectionView(JiajiaoCollectionEntity jiajiaoCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, jiajiaoCollectionEntity);
