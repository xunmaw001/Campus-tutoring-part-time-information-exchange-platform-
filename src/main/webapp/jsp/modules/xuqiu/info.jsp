            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">家教需求登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="xuqiuName" name="xuqiuName" class="form-control"
                                               v-model="ruleForm.xuqiuName" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    <label>图片</label>
                                    <img id="xuqiuPhotoImg" width="100" height="100">
                                </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.xuqiuContent != null && ruleForm.xuqiuContent != 'null' && ruleForm.xuqiuContent != '') {
            var xuqiuContentUeditor = UE.getEditor('xuqiuContentEditor');
                xuqiuContentUeditor.ready(function () {
                    var mes = '' + ruleForm.xuqiuContent;
                    xuqiuContentUeditor.setContent(mes);
                    xuqiuContentUeditor.setDisabled('fullscreen');
            });
        }
    }
