    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑家教需求</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑家教需求</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">家教需求信息</h3>
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>图片</label>
                                        <img id="xuqiuPhotoImg" src="" width="100" height="100">
                                        <input name="file" type="file" id="xuqiuPhotoupload"
                                               class="form-control-file">
                                        <input name="xuqiuPhoto" id="xuqiuPhoto-input" type="hidden">
                                    </div>
                                    <div class="form-group  col-md-6">
                                        <label>详情信息</label>
...
<script>
    ...
    function upload() {
        ...
        <!-- 当前表的文件上传 -->
        $('#xuqiuPhotoupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                var photoUrl= baseUrl + 'file/download?fileName=' + data.result.file;
                document.getElementById('xuqiuPhotoImg').setAttribute('src',photoUrl);
                document.getElementById('xuqiuPhoto-input').setAttribute('value',photoUrl);
            }
        });
    ...
    function showImg() {
        <!--  当前表的图片  -->
        $("#xuqiuPhotoImg").attr("src",ruleForm.xuqiuPhoto);
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $(".aaaaaa").remove();
        if(window.sessionStorage.getItem('addxuqiu') != null && window.sessionStorage.getItem('addxuqiu') !=""){//新增查询,修改不查
            // 查询当前登录账户的信息
            var userId = window.sessionStorage.getItem('userId');
