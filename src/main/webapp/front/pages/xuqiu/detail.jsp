...
<div id="app">
    ...
    <div class="news-container">
        <h1 class="title">{{detail.xuqiuName}}</h1>
        <div class="auth-container" v-if="detail.insertTime">
            时间：{{detail.insertTime}}
        </div>

        <div class="content" v-html="myFilters(detail.xuqiuContent)">
        </div>

        <div class="bottom-container">
            <div class="title">
                本篇文章：{{detail.xuqiuName}}
            </div>
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function () {
        ...
        http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function (res) {
            ...
            vue.detail = res.data;
           // 轮播图片
            vue.swiperList = vue.detail.xuqiuPhoto ? vue.detail.xuqiuPhoto.split(",") : [];
            var swiperItemHtml = '';
