            ...
            <div class="ng-inmod-ini">
              ...
              <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-incontlst-doc ng-incontlst-doc-show">
                        <div class="row">
                            <div class="ng-incontlst-col" v-for="(item,index) in  xuqiuList" v-bind:key="index">
                                <div class="ng-incontlst-bor">
                                    <div class="ng-incontlst-img ng-oa ng-fault">
                                        <a href="javascript:void(0);" @click="jump('../xuqiu/detail.jsp?id='+item.id)">
                                            <img :src="item.xuqiuPhoto?item.xuqiuPhoto.split(',')[0]:''" width="300px" height="300px"/>
                                        </a>
                                    </div>
                                    <div class="ng-fault ng-container">
                                        <div class="ng-incontlst-tit">
                                            <p>{{item.xuqiuName}}</p>
                                            <p style="color: red;" v-if="item.xuqiuNewMoney">{{item.xuqiuNewMoney}} RMB</p>
                                            <span></span>
                                        </div>
                                        <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../xuqiu/detail.jsp?id='+item.id)">查看详情</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="ng-inmod-ini">
              ...
              <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-incontlst-doc ng-incontlst-doc-show">
                        <div class="row">
                            <div class="ng-incontlst-col" v-for="(item,index) in  jiajiaoList" v-bind:key="index">
                                <div class="ng-incontlst-bor">
                                    <div class="ng-incontlst-img ng-oa ng-fault">
                                        <a href="javascript:void(0);" @click="jump('../jiajiao/detail.jsp?id='+item.id)">
                                            <img :src="item.jiajiaoPhoto?item.jiajiaoPhoto.split(',')[0]:''" width="300px" height="300px"/>
                                        </a>
                                    </div>
                                    <div class="ng-fault ng-container">
                                        <div class="ng-incontlst-tit">
                                            <p>{{item.jiajiaoName}}</p>
                                            <p style="color: red;" v-if="item.jiajiaoNewMoney">{{item.jiajiaoNewMoney}} RMB</p>
                                            <span></span>
                                        </div>
                                        <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../jiajiao/detail.jsp?id='+item.id)">查看详情</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function () {
        ...
        http.request('xuqiu/list', 'get', {
            page: 1,
            limit: 6,
        }, function (res) {
            vue.xuqiuList = res.data.list;
            vue.$nextTick(() => {
                $(".teamb-slide-38").slide({
                    mainCell: ".bd ul",
                    autoPage: true,
        ...
        http.request(`jiajiao/list`, 'get', {
            page: 1,
            limit: 6,
            flag: 1
        }, function (res) {
            vue.jiajiaoList = res.data.list;
        });
    });
</script>
