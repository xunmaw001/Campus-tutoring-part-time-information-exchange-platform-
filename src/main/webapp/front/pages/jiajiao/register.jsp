            ...
            <article>
              <form class="layui-form login-form" lay-filter="register">
                ...
                <div class="layui-form-item layui-form-text input">
                  ...
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">家教姓名:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="jiajiaoName" id="jiajiaoName"  placeholder="家教姓名"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">家教类型:</span>
                        <div class="layui-input-inline">
                            <select name="xuqiuTypes" id="xuqiuTypes" lay-filter="xuqiuTypes" style="width: 600px;">
...
<!-- 身份证号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="jiajiaoIdNumber" id="jiajiaoIdNumber"  lay-verify="identity|required"   placeholder="身份证号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
  <!-- 手机号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="jiajiaoPhone" id="jiajiaoPhone"  lay-verify="phone|required"   placeholder="手机号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
  <!-- 邮箱 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="jiajiaoEmail" id="jiajiaoEmail"  lay-verify="email|required"   placeholder="邮箱" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
