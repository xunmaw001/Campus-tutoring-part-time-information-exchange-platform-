...
var centerMenu = [
    ...
    ,{
        name: '家教收藏',
        url: '../jiajiaoCollection/list.jsp'
    }
    ,{
        name: '家教订单',
        url: '../jiajiaoOrder/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '家教需求',
        url: './pages/xuqiu/list.jsp'
    },

]

var adminurl =  "http://localhost:8080/xiaoyuanjiajiaojianzhi/index.jsp";
